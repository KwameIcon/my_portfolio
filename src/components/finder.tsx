    ...
    return (
        <>
            ...
            >
                        ...
                        <section className='w-full flex flex-col items-start justify-start gap-3'>
                            ...
                            <ul className='w-full flex flex-col items-start justify-start gap-3'>
                                {finderLinks.quickLinks.links.map(link => (
                                    <li key={link.url} className='w-full h-8 flex items-center gap-2 cursor-pointer border-b border-[#FFD098] transition-colors duration-200 ease-linear hover:border-white'>
                                        <link.icon className='' />
                ...
                <div className='absolute right-0 top-0 w-[549px] h-full bg-white flex flex-col items-center justify-start gap-5 px-3'>
                    ...
                    <main className='w-full flex flex-col items-center justify-start gap-5 p-4'>
                        ...
                        <h2 className='w-full text-center text-md font-semibold'>I'M THE CREATOR OF IKOS WEB</h2>
